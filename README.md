...
面向测试工程师的本地一体化 AI 工具平台：把 Jmeter 脚本编写、用例设计、报告整理、数据构造这些高频重复劳动，收敛到一个可复用、可验证的工具台中。AI 仅产出结构化草稿，所有结果可预览、可编辑、可导出。（需求分析模块 2026-09 退役，重建方向调研中，见 CONTEXT.md）
...
| 测试报告 | `/testreport` | AI 生成 lieflat-charts 风格单文件 HTML 报告：几句话快速简报或禅道 CSV 双输入，报告记录可回看、对话追改、导出 HTML/PDF |
